    ...
    <div class="container">
                ...
                <div class="col-md-12 mb-4">
                    <div class="shadow bg-white p-3">
                        <h4 class="text-primary">
                            Item Total Amount :
                            <span class="float-end">{{ $totalProductAmount }} EGP</span>
                        </h4>
                        <hr>
                        <small>* items will be delivered in 3 - 5 days.</small>
                        <hr>
                        <small>* Tax and other charges are added ? </small>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="shadow bg-white p-3">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" wire:model.defer="fullname" id="fullname" class="form-control"
                                    placeholder="Enter Full Name Plz">
                                @error('fullname')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" wire:model.defer="phone" id="phone" class="form-control"
                                    placeholder="Enter Phone Number Plz">
                                @error('phone')
                                    <small class="text-danger">{{ $message }} </small>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" wire:model.defer="pincode" id="pincode" class="form-control"
                                    placeholder="Enter Pin-Code Plz">
                                @error('pincode')
                                    <small class="text-danger">{{ $message }} </small>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea wire:model.defer="address" rows="2" id="address" class="form-control"></textarea>
                                @error('address')
                                    <small class="text-danger">{{ $message }} </small>
                                @enderror
                            </div>
        ...
        @else
            <div class="card card-body shadow text-center p-md-5">
                <h4>No itmes in cart to checkout</h4>
...
@push('scripts')
    <script
        src="https://www.paypal.com/sdk/js?client-id=AbhmE0IItlcTeKRSzAXDdaaalZhjX35DSTe--LjUrDLMcxyRF1ELH4mOzrymH_iXboc4od5tY3OSNTbk&currency=USD">
    </script>
    <script>
        paypal.Buttons({
            onClick: function() {
